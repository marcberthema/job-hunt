...
**Senior Platform Deployment Consultant · Kubernetes · Terraform**
...
Senior DevOps engineer with 18 years of Kubernetes and container-platform deployment experience. At Desjardins, automated provisioning of on-demand Kubernetes/ArgoCD environments for a large financial-services JFrog platform; at Énergir, standardized CI/CD and infrastructure delivery across 12 application teams. Terraform and Ansible IaC practice throughout, plus a demonstrated pattern of learning unfamiliar platform-specific tooling cold under a delivery deadline.

## Technical Skills

| Category | Technologies and Practices |
|---|---|
| **Container Platform Deployment** | Kubernetes, Docker, ArgoCD, Helm — environment provisioning and automation |
