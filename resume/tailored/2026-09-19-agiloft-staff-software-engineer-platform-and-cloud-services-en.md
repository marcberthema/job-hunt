...
**Staff Software Engineer · Platform & Cloud Services · AWS · Terraform**
...
Senior DevOps and platform engineer with 18 years of infrastructure automation experience and hands-on AWS build background. At Tink, built the compute, caching, and database layers of a client's AWS migration target environment — EC2, S3, Route 53, VPC, serverless database — with no prior AWS experience. At Énergir and Desjardins, standardized CI/CD, Terraform IaC, and Kubernetes/ArgoCD automation across regulated enterprise environments. Strong Python/FastAPI background for building internal services with a real operational audience.

## Technical Skills

| Category | Technologies and Practices |
|---|---|
| **Cloud Infrastructure** | AWS (EC2, S3, Route 53, VPC — hands-on build, see Work Experience), Microsoft Azure (production) |
| **Infrastructure as Code** | Terraform, Ansible, Puppet |
| **Platform Engineering** | Kubernetes, Docker, ArgoCD, CI/CD standardization across heterogeneous stacks |
| **Programming** | Python, FastAPI, Bash, Java, SQL, NoSQL |
| **Observability** | Dynatrace, Splunk, ELK Stack |
| **CI/CD** | Azure DevOps, GitHub Actions, Jenkins Pipeline as Code |
