...
Senior DevOps and platform engineer with 18 years of experience building internal tooling and CI/CD automation across regulated enterprise environments. At Desjardins, built a Python/FastAPI service and automated Kubernetes/ArgoCD environment provisioning; at Énergir, standardized CI/CD delivery across 12 application teams and nine runtimes. Deep Terraform/Ansible IaC practice, with a demonstrated pattern of learning unfamiliar platforms and tooling cold under a delivery deadline.

## Technical Skills

| Category | Technologies and Practices |
|---|---|
| **Platform Engineering** | Internal tooling, CI/CD standardization, environment automation |
