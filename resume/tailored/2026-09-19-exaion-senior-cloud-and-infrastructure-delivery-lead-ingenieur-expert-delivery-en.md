...
**Ingénieur DevOps senior · Ansible · Terraform · Kubernetes**
...
Ingénieur DevOps senior avec 18 ans d'expérience en automatisation d'infrastructure, analyse des causes profondes (RCA) et pratique Ansible/Terraform en environnements réglementés. Chez Desjardins, a automatisé le provisionnement d'environnements Kubernetes/ArgoCD à la demande pour une plateforme Artifactory d'entreprise; chez Énergir, pilote l'analyse RCA et la surveillance proactive pour 70+ applications. Solide pratique de script Bash/Python/PowerShell et apprentissage rapide de nouvelles plateformes sous délai serré.

## Technical Skills

| Category | Technologies and Practices |
|---|---|
| **Automatisation d'infrastructure** | Ansible, Terraform, gestion de configuration à l'échelle du parc |
| **Conteneurs et orchestration** | Kubernetes, Docker, ArgoCD |
| **Scripting** | Bash, Python, PowerShell |
| **Fiabilité et supervision** | Analyse des causes profondes (RCA), post-mortems, surveillance proactive, remédiation automatisée |
| **Observabilité** | Dynatrace, Splunk, ELK Stack |
| **Plateformes infonuagiques** | Microsoft Azure (production), AWS (EC2, S3, Route 53, VPC — build pratique) |
