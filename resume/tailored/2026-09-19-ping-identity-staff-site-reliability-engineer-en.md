...
**Staff Site Reliability Engineer · Kubernetes · Terraform · Observability**
...
Senior SRE and DevOps engineer with 18 years of experience reducing operational toil and MTTR through automation and root-cause-driven prevention. At Énergir, drives RCA on critical incidents and built proactive monitoring, dashboards, and automated remediation across 70+ applications; at Tink, cut on-call paging frequency roughly in half and built self-healing automation for an unstable Elasticsearch cluster. Deep Terraform, Kubernetes, and Python/Bash automation practice across regulated enterprise environments.

## Technical Skills

| Category | Technologies and Practices |
|---|---|
| **Site Reliability Engineering** | Root-cause analysis, MTTR reduction, automated remediation, self-healing automation, 24/7 on-call |
...
| **Observability** | Dynatrace, Splunk, ELK Stack, PRTG |
