...
**Senior Platform Engineer · Kubernetes · CNCF · Terraform**
...
Senior DevOps and platform engineer with 18 years of experience standardizing infrastructure delivery and driving platform-engineering adoption across teams. At Énergir, drove CI/CD and platform-engineering adoption across 12 application teams outside any reporting line; at Desjardins, automated Kubernetes/ArgoCD environment provisioning for an enterprise platform. Deep Terraform/Ansible IaC practice, with growing Kubernetes-native depth (CKA in progress).

## Technical Skills

| Category | Technologies and Practices |
|---|---|
| **Platform Engineering & Enablement** | Cross-team enablement without reporting authority, internal developer tooling, standards documentation |
