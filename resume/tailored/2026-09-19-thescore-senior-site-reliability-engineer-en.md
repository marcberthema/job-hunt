...
**Senior Site Reliability Engineer · GCP/AWS · Kubernetes · Incident Response**
...
Senior SRE and DevOps engineer with 18 years of experience in incident response, observability, and infrastructure-as-code across regulated sectors. At Énergir, drives RCA on critical incidents and built automated remediation across 70+ applications; at Desjardins, automated Kubernetes/ArgoCD provisioning and built Splunk alerting for a regulated financial-services platform. Deep GitHub Actions CI/CD practice, plus a demonstrated pattern of learning unfamiliar cloud platforms cold under delivery pressure.

## Technical Skills

| Category | Technologies and Practices |
|---|---|
| **Site Reliability Engineering** | Incident response, root-cause analysis, MTTR reduction, automated remediation, 24/7 on-call |
...
| **Programming** | Python, Bash, FastAPI, Java |
