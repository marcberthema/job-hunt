...
**Senior DevOps Architect · Terraform · Python Automation**
...
Senior DevOps engineer with 18 years of infrastructure-as-code and automation experience. Deep, current Terraform and Ansible practice at Énergir standardizing environment provisioning across dev/staging/production; strong Python/FastAPI automation background from building production services at Desjardins. Architecture-adjacent scope delivered under Senior/Staff DevOps Engineer titles across three employers, with a demonstrated pattern of learning unfamiliar platforms cold under a delivery deadline.

## Technical Skills

| Category | Technologies and Practices |
|---|---|
| **Infrastructure as Code** | Terraform, Ansible, Puppet — production standardization and drift elimination |
| **Automation & Scripting** | Python, FastAPI, Bash |
| **Containers & Orchestration** | Kubernetes, Docker, ArgoCD |
| **Cloud Platforms** | Microsoft Azure (production), AWS (EC2, S3, Route 53, VPC — hands-on build) |
