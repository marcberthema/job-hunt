...
**Senior Site Reliability Engineer · Kubernetes · Terraform · AWS/Azure**
...
Senior SRE and DevOps engineer with 18 years of experience owning production reliability, incident response, and Kubernetes/Terraform-based infrastructure automation. At Énergir, drove RCA on critical incidents and built proactive monitoring and automated remediation across 70+ applications; at Desjardins, automated Kubernetes/ArgoCD provisioning and built Prometheus/Grafana-equivalent observability (Dynatrace) for a financial-services JFrog platform. Deep GitHub Actions and CI/CD runbook discipline, plus hands-on AWS build experience.

## Technical Skills

| Category | Technologies and Practices |
|---|---|
| **Reliability Engineering** | Root-cause analysis, MTTR reduction, incident response, runbooks, automated remediation, 24/7 on-call |
| **Containers & Orchestration** | Kubernetes, Docker, ArgoCD |
| **Infrastructure as Code** | Terraform, Ansible |
| **Cloud Platforms** | AWS (EC2, S3, Route 53, VPC — hands-on build), Microsoft Azure (production) |
| **Observability** | Dynatrace, Splunk, ELK Stack, Prometheus/Grafana-equivalent dashboards |
| **CI/CD** | GitHub Actions, Azure DevOps, Jenkins Pipeline as Code |
