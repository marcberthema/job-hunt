# Cloud Engineer (Azure Platform Engineer) — Smile Digital Health

- **Source:** https://builtin.com/job/cloud-engineer-azure-platform-engineer-remote-ontario/10464451
- **Found:** 2026-08-20
...
Deep Azure skill match: production Azure Kubernetes Service (AKS) cluster architecture, networking, security hardening, Terraform IaC, and GitOps (Flux/ArgoCD) — directly aligned with Marc's Azure modernization and ArgoCD provisioning work at Énergir and Desjardins. The posting prefers CKA/CKAD plus Microsoft Azure Administrator (AZ-104) certification — Marc has paused AZ-104 study but this is a strong signal to finish it. Full-time-only status and below-target salary keep this from a 9-10, but the skill overlap is close to exact.
...
- Note Dynatrace/Splunk observability experience as transferable to this posting's Grafana-stack/Azure Monitor observability scope.
...
I'm incorporated in Canada, fully bilingual, and comfortable operating remotely within Ontario. I'd welcome a conversation about the role.
